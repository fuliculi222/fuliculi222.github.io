...
El Estado es la organización que puede coercionar con legitimidad, o sea quien puede obligarte a seguir sus normas o enfrentar su fuerza, dentro de un territorio. (Así dice Max Weber en La política como vocación). 
Este es un buen ejemplo de abstracción, vacía de contenido histórico y hecha en el sentido formal. 

Y aún seguimos aprendiendo así, porque la ciencia dominante funciona en base a abstraer el contenido concreto según su nivel de repetición y a aplicarlo después de forma exterior. Si nos preguntamos ¿Cómo funciona el Estado capitalista? Ahí tenemos un objeto real, conreto, de estudio. Nos preguntamos por las leyes de funcionamiento (por la necesidad) del Estado en relación con el capita. ¿Hay autonomía? ¿Qué intereses se ven reflejados? No tengo la respuesta para esas preguntas por mí mismo, y tampoco pienso partir en este momento.
